...
public class Seminar {
     ...
     * @return Метод возвращает новый массив, в котором элементы сдвинуты на заданное количество позиций вправо.
     */
    ...
    /**
     * Задача: Написать метод, в который передается
     *
     * @param array не пустой одномерный целочисленный массив,
     * @return метод должен вернуть true если в массиве есть место,
